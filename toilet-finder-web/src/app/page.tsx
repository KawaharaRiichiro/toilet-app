          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="join border border-gray-300 bg-white rounded-lg overflow-hidden">
                {/* 全て */}
                <button 
                  className={`join-item btn btn-sm px-4 font-medium transition-colors duration-200 ${filters.inside_gate === null ? 'bg-blue-600 hover:bg-blue-700 !text-white border-blue-600' : 'bg-white text-gray-700 hover:bg-gray-100 border-gray-300'}`}
                ...
                {/* 改札内 */}
                <button 
                  className={`join-item btn btn-sm px-4 font-medium transition-colors duration-200 ${filters.inside_gate === true ? 'bg-blue-600 hover:bg-blue-700 !text-white border-blue-600' : 'bg-white text-gray-700 hover:bg-gray-100 border-gray-300'}`}
